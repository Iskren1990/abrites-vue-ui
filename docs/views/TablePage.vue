...
import { ITableAction } from "../../src/components/table/ITableAction";
import { ITableColumn } from "../../src/components/table/ITableColumn";
import { ISortData } from "../../src/components/table/ISortData";
